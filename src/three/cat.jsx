...
export function CatModel(props) {
  ...
  //     timeline.to(catRef.current.position, {
  //       delay: 0,
  //       duration: 2,
  //       y: 0,
  //       ease: 'none',
  ...
  const { nodes, materials } = useGLTF('porche/aki5-transformed.glb');
  return (
...
useGLTF.preload('/porche/aki5-transformed.glb');
